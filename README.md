...
7. v2raya 若使用 xray-core，建议参考[ v2raya 官方文档](https://v2raya.org/docs/advanced-application/custom-extra-config/) 使用[本生命周期钩子脚本](https://github.com/PaPerseller/r2s-armbian-configure/blob/main/core-hook.py)将 domainMatcher 的值设为 hybrid，若服务器启用了 tcpMptcp，则脚本中可选启用客户端  tcpMptcp。
